...
def display_results():
    ...
    print('Institutional Fee                $ ' + format(inst_amt,'10,.2f'))
    print('Student Activity Fee             $ ' + format(act_amt,'10,.2f'))
    print('Capital Fee                      $ ' + format(cap_amt,'10,.2f'))
    print('Total                            $ ' + format(total,'10,.2f'))
    print('Scholorship                      $ ' + format(scholar_amt,'10,.2f'))
    print(d_dashes)
    print('Balance Due                      $ ' + format(balance,'10,.2f'))
    print(dashes)
